...
DECLARE
    ...
    batch_str text;
BEGIN
    -- Bersihkan data auth lama jika ada
    ...
    VALUES 
    (konsumen_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'konsumen@gmail.com', crypt('123456', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"role":"KONSUMEN"}', now(), now()),
    (petugas_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'petugas@gmail.com', crypt('123456', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"role":"PETUGAS"}', now(), now()),
    (produsen_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'produsen@gmail.com', crypt('123456', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"role":"BRAND"}', now(), now());
